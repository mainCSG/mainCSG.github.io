...
Note: To use the theme, you do ***not*** need to clone or fork the [QuDiPy Repo]! You should do that only if you intend to browse the theme docs locally, contribute to the development of the theme, or develop a new theme based on Just the Docs.
...
[QuDiPy Repo]: https://github.com/just-the-docs/just-the-docs
